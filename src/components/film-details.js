...
import {createGenresMarkup} from "./genre.js";
import {createCommentsMarkup} from "./comment";

export const createFilmDetailsTemplate = (film) => {
  const {title, originalTitle, rating, director, writers, actors, releaseDate, duration, country, genre, poster, description, age, isAddToWatchlist, isMarkAsWatched, isFavorite, comments} = film;
